...
async function sendOTPSMS(phone, otp) {
  ...
  await client.messages.create({
    body: `Your UniConnect OTP is ${otp}. It expires in 10 minutes.`,
...
/**
 * Generic sendMail - used by ticket.js and other routes
...
module.exports = { sendOTPEmail, sendOTPSMS, verifyConnection, sendMail };
